...
static int n, q, sp[400000 + 1];
static LCT lct;
static vector<Query> queries[400000 + 1];
static vector<int> ins[400000 + 1], del[400000 + 1];
static vector<int> tog[400000 + 2];
