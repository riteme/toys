...
* **purport** /pəˈpɔ:t/ 声称，意图，打算 v / n **purported** adj 传说的，谣传的
...
* emerge vi 出现，浮现（to come out of dark/hidden place; to become known)

* hemisphere n 地球半球，大脑半球

* vigorous adj 充满活力的 (energetic); 强壮的
...
* dodge v 躲避，逃避; n 伎俩 (dishonest trick)

* wholly 完全的 (completely, totally)
...
* denomination n （尤指钱的）面额

* obsolete adj 废弃的；淘汰的；过时的 (no longer used because sth new has been invented)

* canonical adj 经典的；（数学表达式）最简洁的；标准的

* preliminary adj 初步的，预备性的；n 初步行动

* equivalent adj （价值、数量、意义、重要性等）相等的；equivalence n
